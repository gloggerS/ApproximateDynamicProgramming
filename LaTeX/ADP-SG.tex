...
\input{TODOInterestingFindings.tex}
%

%\backmatter %TODO das vll rausnehmen
\todo{Bibliographie-Einträge checken}
%\addcontentsline{toc}{chapter}{Bibliography}
\bibliography{bibliography}
\printnomenclature

\appendix
\input{NotesOnCode.tex}
\addtocounter{chapter}{1}
\addcontentsline{toc}{chapter}{\protect\numberline{\thechapter}Code Implementation}\label{ch:code}
\includepdf[pages=-]{presentation_of_code.pdf}

\input{Appendix.tex}

\input{SchriftlicheVersicherung.tex}
