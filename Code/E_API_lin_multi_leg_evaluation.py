...
#%%
result_folder = "C:\\Users\\Stefan\\LRZ Sync+Share\\Masterarbeit-Klein\\Code\\Results\\exampleStefan-True-APILinearMultiLeg-190924-1450"
...
logfile, newpath, var_capacities, var_no_purchase_preferences, resources, products, revenues, A, \
        ...
        K, online_K, I \
    = setup_testing("APILinearMultiLeg"+str(which_policy_iteration_to_use)+"-evaluation")
...
for capacities in var_capacities:
    for no_purchase_preference in var_no_purchase_preferences:
        ...
        with open(storedpath + "\\piToUse.data", "rb") as filehandle:
        ...
        if np.sum(p != p2[which_policy_iteration_to_use, :, :]) > 0:
            warn(" === \n You currently don't use the most recent policy iteration. Variable to adjust: which_policy_iteration_to_use === \n\n\n\n\n")

        pis_for_setting = pi_result[which_policy_iteration_to_use, :, :]
...
print("E_API_lin_multi_leg_evaluation.py completed.")