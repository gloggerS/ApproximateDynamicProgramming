...
def objective(params, n_folds=N_FOLDS):
    """Objective functiony_true for Gradient Boosting Machine Hyperparameter Tuning"""

    # Perform n_fold cross validation with hyperparameters
    # Use early stopping and evalute based on MAE
    # use stratified = False to handle regresion
    cv_results = lgb.cv(params, train_set, nfold=n_folds, num_boost_round=1000, early_stopping_rounds=100,
        metrics='mae', seed=50, stratified=False)
...
space = {
    ...
    'hidden_layer_sizes': hp.choice('hidden_layer_sizes', [(10,), (50,10,), (100, 10, 10,)])
}
