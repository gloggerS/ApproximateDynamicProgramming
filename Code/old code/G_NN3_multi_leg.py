...
def update_parameters_NN(v_samples, c_samples, silent=True):
    ...
    neural_net = MLPRegressor(alpha=.1, hidden_layer_sizes=(10,), max_iter=50000,
                              activation='tanh', verbose=not silent, learning_rate='adaptive')
    m11 = neural_net.fit(X, y)
