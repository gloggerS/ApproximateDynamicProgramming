...
*** Verständnis von CDLP by column generation richtig?
zunächst wird pi auf 0 gesetzt (duale Kosten der Ressourcen)
dann wird versucht die Greedy Heuristic zu lösen
falls das scheitert (nur 0en kommen zurück), wird MIP angeworfen, um offerSetsAll zu bestimmen
mit dem ersten offerSetsAll wird CDLP reduced gelöst
wir erhalten den optimalen Zielwert und die dualen Variablen
jetzt solange wiederholen, bis sich Zielwert nicht weiter verbessert:
...
***** TODO Bront DCOMP 
      :LOGBOOK:
      CLOCK: [2019-03-21 Do 10:10]--[2019-03-21 Do 10:55] =>  0:45
...
****** TODO CDLP by column generation
