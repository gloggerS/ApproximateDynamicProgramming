...
** https://arxiv.org/pdf/1810.08124.pdf					:pdf:
** https://arxiv.org/pdf/1810.03847.pdf					:pdf:
...
möchte den Lehrstuhl kennenlernen (dafür war Mittagessen schon gute Gelegenheit; Tutorien wsl. schon alle vergeben (aber könnte mir gut vorstellen, am Lehrstuhl zu unterstützen)
Projekt in Python implementieren (Zusammenspiel Python und Gurobi)
** Arbeitsweise 
Ansprechpartner am Lehrstuhl (Betreuer): 
