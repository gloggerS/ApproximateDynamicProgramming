...
#+STARTUP: entitiespretty logdone
...
**** Problem als Klasse definieren, dann Struktur mit konkretem Beispiel laden
**** Auch Ergebnis von Optimierung als Klasse zurückgeben (gleich das Modell?)
** Fragen
*** Wie hast du den Datenaustausch implementiert, also dass man schnell verschiedene Beispieldatensätze durchrechnen kann?
Idee: ein Python file "data", in dem alle Beispieldatensätze drin sind. Dieses wird dann angepasst, und Code laufen gelassen.
*** Welche Struktur des Codes ist sinnvoll?
globale Daten
Funktionalitäten
Ergebnisse berechnen und darstellen (und automatisch mit Zeitstempel abspeichern in Ordner)
*** Wie funktioniert das Debuggen in Python (Pycharm oder Spyder)? 
* Overall
...
**** TODO Python Skills auffrischen mit Tutorial python-kurs.eu [33/44]
CLOCK: [2019-03-19 Di 09:32]--[2019-03-19 Di 09:52] =>  0:20
CLOCK: [2019-03-15 Fr 09:34]--[2019-03-15 Fr 10:02] =>  0:28
CLOCK: [2019-03-14 Do 17:15]--[2019-03-14 Do 17:53] =>  0:38
CLOCK: [2019-03-14 Do 09:20]--[2019-03-14 Do 10:22] =>  1:02
CLOCK: [2019-03-13 Mi 09:06]--[2019-03-13 Mi 10:02] =>  0:56
...
***** DONE Daten lesen und schreiben
CLOSED: [2019-03-13 Mi 09:32]
***** DONE Modularisierung: Module
CLOSED: [2019-03-13 Mi 09:45]
***** DONE Tests, Doctest und UnitTest
CLOSED: [2019-03-13 Mi 10:02]
***** DONE Reguläre Ausdrücke
***** DONE Reguläre Ausdrücke, Fortgeschrittene
***** DONE Modularisierung: Pakete
***** DONE Lambda-Operator, map- filter- und reduce-Funktion
***** DONE Listen-Abstraktion (List Comprehension)
***** DONE Generatoren und Iteratoren
send Methode nicht verstanden
***** DONE Ausnahme-Behandlung
...
**** DONE Dynamiches Programm dazu mit Zeitvergleich mit und ohne Memoisation 
CLOCK: [2019-03-12 Di 17:54]--[2019-03-12 Di 18:06] =>  0:12
Zeitvergleich noch ergänzen
CLOSED: [2019-03-12 Di 17:53]
CLOCK: [2019-03-12 Di 16:00]--[2019-03-12 Di 17:53] =>  1:53
...
****** DONE Memoisation von customer_ choiche_ segments
CLOSED: [2019-03-12 Di 17:53]
****** DONE Memoisation von value_ expected
CLOSED: [2019-03-12 Di 17:53]
...
**** TODO Paper Koch nachimplementieren
     :LOGBOOK:
     CLOCK: [2019-03-19 Di 16:39]--[2019-03-19 Di 17:36] =>  0:57
     CLOCK: [2019-03-19 Di 16:04]--[2019-03-19 Di 16:04] =>  0:00
     :END:
***** DONE Figure 2
CLOCK: [2019-03-13 Mi 13:28]--[2019-03-13 Mi 13:28] =>  0:00
CLOCK: [2019-03-13 Mi 11:03]--[2019-03-13 Mi 12:28] =>  1:25
***** DONE samplePath mit Anpassung offerSet
***** DONE API linear
CLOCK: [2019-03-16 Sa 09:00]--[2019-03-16 Sa 10:01] =>  1:01
CLOCK: [2019-03-15 Fr 13:11]--[2019-03-15 Fr 18:04] =>  4:53
CLOCK: [2019-03-15 Fr 10:25]--[2019-03-15 Fr 11:45] =>  1:20
:PROPERTIES:
:ORDERED:  t
:END:
***** DONE API piecewise linear
CLOSED: [2019-03-19 Di 14:53]
***** TODO bisherigen Code Überarbeiten
***** DONE Bront CDLP 
      CLOSED: [2019-03-20 Mi 12:18]
      :LOGBOOK:
      CLOCK: [2019-03-20 Mi 10:09]--[2019-03-20 Mi 12:17] =>  2:08
      CLOCK: [2019-03-20 Mi 10:09]--[2019-03-20 Mi 10:09] =>  0:00
      :END:
***** TODO Bront DCOMP 

****** DONE MIP formulation
       CLOSED: [2019-03-20 Mi 17:59]
****** DONE greedy heuristic
      :LOGBOOK:
      CLOCK: [2019-03-20 Mi 13:17]--[2019-03-20 Mi 17:57]
      :END:

       CLOSED: [2019-03-20 Mi 17:59]

****** TODO leg level decomposition
       :LOGBOOK:
       CLOCK: [2019-03-21 Do 15:38]
       :END:
****** TODO check CDLP by column generation
...
** Gurobi
[[https://medium.com/opex-analytics/optimization-modeling-in-python-pulp-gurobi-and-cplex-83a62129807a][Blog on Optimization Modeling in Python]]
* Erweiterungen
...
** Sparse Data Structure verwenden
* Tagebuch
...
Bericht erstellt zur Performanz der Memoisierung
** Und heute?<2019-03-13 Mi>
Mal sehen, wie es weiter gehen kann
Datei = Daten + Kartei (Portmonteau oder Kofferwort)
Figure 2 aus Koch nachimplementieren
Value Expected überarbeiten (optimal policy zurückgeben, ArrivalProbability berücksichtigen)
Schwierigkeit, die Daten sauber von den Funktionen zu trennen (bisher preferenceWeights als globale Variablen)
Python neu installiert, da Gurobi-Schnittstelle nicht dazugeladen werden konnte
Paper Koch zusammenfassen
Altbewährtes SciView Problem wieder gelöst [[https://youtrack.jetbrains.com/issue/PY-29684][SciView Lösung]]
** Auf ein Neues<2019-03-14 Do>
samplePath angepasst, jetzt wird offerSet je Zeitschritt berechnet
Code refactored
Paper von Sebastian komplett durchgearbeitet und in Citavi überführt
** Erste Woche rum, Paper von Sebastian nachgebaut<2019-03-15 Fr>
Zeit in Notation wie bei Paper Sebastian (t aufsteigend bis Ende T)
Code Richtung Bront erweitert (mehrere Segmente hinzugefügt, offer-set calculation mit marginal Nutzen)
Policy evaluation implementiert
Gurobi Optimierung gestartet
** A bissle geht no<2019-03-16 Sa>
Weiter an der Gurobi Optimierung gewerkelt und abgeschlossen
Erfolgreiche Woche, Paper von Sebastian in Grundstruktur nachimplementiert :)
** Weiter in der neuen Woche<2019-03-19 Di> 
Paper von Miranda Bront et al gelesen und zusammengefasst
Implementierung gestartet
Spacemacs begonnen (installiert und vim Tutorium gestartet)

** Bront implementieren und Spaß haben<2019-03-20 Mi>
CDLP implementieren und Ergebnis mit Example 0 vergleichen
Spacemacs weitertreiben (vim Tutorium durchgearbeitet)
regular expression um optimierte Variablen zu erhalten
Gurobi Constraints bulk weise hinzufügen
"and" is lazy version of "&"
ideavim auch in Pycharm hinzufügen

** Schnelles Programmieren hat seine Tücken<2019-03-21 Do> 
Implementieren an Bront
CDLP-reduced fertig
Herausfinden, ob Row schon im data-frame ist
Ich werde vertrauter mit dem Indexing von data-frames
Bisschen ein Durcheinander ohne kommentierte Funktionen (welcher Datentyp wird erwartet, in welcher Reihenfolge, ...)
Duale Variablen passen nicht
leg level decomposition passt nicht ganz (Indices laufen falsch zusammen)
Paradigma: Produkte sind von 1 ab durchnummeriert, kein Kauf bei 0 und daran festhalten
Entsprechend das komplette working-file überarbeiten
Offer-Sets und Duale Preise werden noch nicht korrekt berechnet
Aber CDLP ist jetzt korrekt 
